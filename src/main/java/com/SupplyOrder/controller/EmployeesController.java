...
public class EmployeesController {
    ...
    @RequestMapping(value = "/api/employees", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Employees> addEmployee(@RequestBody Employees employee) {
        return new ResponseEntity<>(employeesService.addEmployee(employee), HttpStatus.CREATED);
    }
}